  ...
  namespace :extensions do
    namespace :issue_tracker do
      ...
      task :update => :environment do
        ...
        unless IssueTrackerExtension.root.starts_with? RAILS_ROOT # don't need to copy vendored tasks
          puts "Copying rake tasks from IssueTrackerExtension"
          local_tasks_path = File.join(RAILS_ROOT, %w(lib tasks))
          mkdir_p local_tasks_path, :verbose => false
          Dir[File.join IssueTrackerExtension.root, %w(lib tasks *.rake)].each do |file|
      ...
      task :sync => :environment do
        ...
        language_root = IssueTrackerExtension.root + "/config/locales"
